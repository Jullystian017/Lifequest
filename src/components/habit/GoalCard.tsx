            ...
            <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                    <div className="space-y-1">
                        <span className="inline-block px-2 py-0.5 rounded text-[8px] font-semibold uppercase tracking-widest bg-[var(--primary)]/10 text-[var(--primary)] border border-[var(--primary)]/20">
                            {goal.category}
                        </span>
                        <h3 className="text-lg font-semibold text-white font-[family-name:var(--font-heading)]">{goal.title}</h3>
                    ...
                    >
                        <div className="p-6 pt-4 space-y-4">
                            <div className="flex items-center justify-between">
                                <h4 className="text-[10px] font-semibold text-slate-500 uppercase tracking-[2px]">Requirements ({completedMilestones}/{totalMilestones})</h4>
                                <span className="text-[9px] font-semibold text-emerald-400">+{goal.xp_reward} XP REWARD</span>
                            </div>
                            ...
                            <div className="space-y-2">
                                {goal.milestones.map((milestone) => (
                                    ...
                                    >
                                        ...
                                        <span className={`text-xs font-semibold transition-colors ${milestone.is_completed ? "text-slate-500 line-through" : "text-slate-200"
                                            }`}>
                                            {milestone.title}
                                        </span>
                                    </div>
