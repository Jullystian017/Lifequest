           ...
           <div className="container mx-auto px-6 text-center">
              <div className="max-w-3xl mx-auto p-10 rounded-3xl bg-gradient-to-br from-[var(--primary)]/10 to-[var(--secondary)]/5 border border-[var(--border-light)] backdrop-blur-3xl relative overflow-hidden group">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
                    <button suppressHydrationWarning className="w-full sm:w-auto px-8 py-3.5 bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white text-sm font-semibold rounded-xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[var(--primary)]/20">
                        Create Account
                    </button>
                    <button suppressHydrationWarning className="w-full sm:w-auto px-8 py-3.5 bg-transparent border border-[var(--border-light)] text-[var(--text-secondary)] text-sm font-semibold rounded-xl hover:bg-white/5 transition-all active:scale-95">
                        Read Features
                    </button>
                </div>
              </div>
